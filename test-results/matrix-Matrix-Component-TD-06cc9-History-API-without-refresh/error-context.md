...
- Name: matrix.spec.ts >> Matrix Component TDD >> should navigate via History API without refresh
- Location: tests/matrix.spec.ts:30:5
...
Call log:
  - waiting for locator('a[href="/schema"]')
