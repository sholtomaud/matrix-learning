...
- Name: matrix.spec.ts >> Matrix Component TDD >> should persist data to IndexedDB on update
- Location: tests/matrix.spec.ts:17:5
...
Call log:
  - waiting for locator('button#load-example')
